...
const SubcategoryPage = () => {
  ...
  // Busca todas as subcategorias da mesma categoria para navegação
              ...
              {prevSubcategory ? (
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm font-medium group-hover:text-primary transition-colors">{prevSubcategory.name}</p>
                  </div>
                </Link>
              ) : <div />}
              ...
              {nextSubcategory ? (
                ...
                >
                  <div className="text-right">
                    ...
                    <p className="text-sm font-medium group-hover:text-primary transition-colors">{nextSubcategory.name}</p>
                  </div>
                  <div className="flex items-center justify-center w-10 h-10 rounded-full border border-border group-hover:border-primary group-hover:text-primary transition-colors flex-shrink-0">
