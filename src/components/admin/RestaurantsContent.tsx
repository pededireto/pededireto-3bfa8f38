      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <RestaurantForm zones={zones} restaurant={editingRestaurant} onClose={handleCloseDialog} />
          </DialogContent>
        </Dialog>
      </div>
...
const RestaurantForm = ({ zones, restaurant, onClose }: RestaurantFormProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 py-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="logo">URL do Logótipo - Colocar Link de uma imagem sem ser o url de uma imagem facebook</Label>
        <Input
          id="logo"
          placeholder="https://..."
