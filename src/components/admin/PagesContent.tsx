...
import { Loader2, Pencil, FileText, Eye, EyeOff, Plus, Trash2, LayoutTemplate, Code } from "lucide-react";
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction onClick={() => handleDelete(page.id)}>Apagar</AlertDialogAction>
                  </AlertDialogFooter>
                </AlertDialogContent>
              </AlertDialog>
            </div>
