    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Tem um problema? Nós mostramos quem resolve."
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Restaurantes, serviços, lojas e profissionais — tudo num só sítio."
            />
          </div>
        </div>
          ...
          <div className="space-y-2">
            ...
            {form.hero_video_url && (
              <div className="mt-2 aspect-video max-w-xs rounded overflow-hidden">
                <iframe
                  src={(() => {
                    const m = form.hero_video_url.match(
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setForm({ ...form, mascot_url: e.target.value })}
                placeholder="https://..."
              />
      ...
      <div className="bg-card rounded-xl p-6 shadow-card space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Desenvolvido por Delivery Masters"
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="https://deliverymasters.pt/sites-institucionais"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="geral@pededireto.pt"
            />
          </div>
          <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            value={form.texto_institucional_home || ""}
            onChange={(e) => setForm({ ...form, texto_institucional_home: e.target.value })}
            rows={3}
            placeholder="Encontre rapidamente o contacto que resolve o seu problema..."
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setForm({ ...form, footer_linkedin: e.target.value })}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setForm({ ...form, footer_youtube: e.target.value })}
      ...
      <div className="bg-card rounded-xl p-6 shadow-card space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              type="number"
              value={form.super_highlights_limit || "6"}
              onChange={(e) => setForm({ ...form, super_highlights_limit: e.target.value })}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              type="number"
              value={form.category_highlights_limit || "3"}
              onChange={(e) => setForm({ ...form, category_highlights_limit: e.target.value })}
            />
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            value={form.emergency_categories || ""}
            onChange={(e) => setForm({ ...form, emergency_categories: e.target.value })}
          />
        </div>
      </div>
      ...
      <div className="bg-card rounded-xl p-6 shadow-card space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-2">
            ...
            <Input
              type="number"
              value={form.highlights_super_limit || "6"}
              onChange={(e) => setForm({ ...form, highlights_super_limit: e.target.value })}
            />
          </div>
          <div className="space-y-2">
            <Label>Limite por Categoria</Label>
            <Input
              type="number"
              value={form.highlights_category_limit || "3"}
              onChange={(e) => setForm({ ...form, highlights_category_limit: e.target.value })}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              type="number"
              value={form.highlights_subcategory_limit || "3"}
              onChange={(e) => setForm({ ...form, highlights_subcategory_limit: e.target.value })}
            />
          </div>
        </div>
