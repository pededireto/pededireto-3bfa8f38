-- =====================================================
-- FIX 1: trg_alert_all_rejected — 'rejected' → 'recusado'
-- =====================================================
...
-- =====================================================
-- FIX 2: trg_log_consumer_match_accepted_activity — 'accepted' → 'aceite'
-- =====================================================
...
-- =====================================================
-- FIX 3: notify_consumer_on_match_accepted — 'accepted' → 'aceite'
-- =====================================================
...
-- =====================================================
-- FIX 4: check_unanswered_24h — 'accepted' → 'aceite'
-- =====================================================
...
BEGIN
  ...
  WHERE sr.created_at < now() - interval '24 hours'
    ...
    AND NOT EXISTS (
      ...
      WHERE rbm.request_id = sr.id AND rbm.status = 'aceite'
    )
    AND NOT EXISTS (
...
-- =====================================================
-- FIX 5: check_and_award_automatic_badges — 'accepted' → 'aceite'
-- =====================================================
...
-- =====================================================
-- FIX 6: compute_badge_progress — 'accepted' → 'aceite'
-- =====================================================
...
-- =====================================================
-- CLEANUP: Remove duplicate trigger that used English 'accepted'
-- The functionality is already covered by trg_notify_consumer_match_accept
-- which correctly uses 'aceite'
-- =====================================================
